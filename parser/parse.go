...
const syslog_first_final int = 590
...
//line parse.go:1308
	...
	tr7:
//line parse.rl:41
		message.SetPriority(atoi(data[mark:p]))
		goto st8
	st8:
		if p++; p == pe {
			goto _test_eof8
...
//line parse.go:1360
	...
	tr10:
//line parse.rl:40
		message.SetVersion(atoi(data[mark:p]))
		goto st10
	st10:
		if p++; p == pe {
			goto _test_eof10
...
//line parse.go:1464
	...
	tr17:
//line parse.rl:42
		message.SetHostname(data[mark:p])
		goto st14
	st14:
		if p++; p == pe {
			goto _test_eof14
...
//line parse.go:1503
	...
	tr21:
//line parse.rl:43
		message.SetAppname(data[mark:p])
		goto st16
	st16:
		if p++; p == pe {
			goto _test_eof16
...
//line parse.go:10999
	...
	_test_eof:
		...
		if p == eof {
			...
			case 592:
//line parse.rl:46
				message.SetMessage(data[mark:p])
			case 591:
//line parse.rl:36
				mark = p
//line parse.rl:46
