%%{
  ...
  msg_id   = nil | ((printusascii{1,32} -- nil) >mark %msgid);
  proc_id  = nil | ((printusascii{1,128} -- nil) >mark %procid);
  app_name = nil | ((printusascii{1,48} -- nil) >mark %appname);

  hostname = nil | ((printusascii{1,255} -- nil) >mark %hostname);
